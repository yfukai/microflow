...
@dataclass
class Config:
    file_path : str = "/work/fukai/2025-11-23-timelapse/work/e9/b973f093ae5fd67918d48e8da4b4f8/shading_corrected.zarr"
    metadata_path : str = "/work/fukai/2025-11-23-timelapse/work/e9/b973f093ae5fd67918d48e8da4b4f8/metadata.yaml"
...
with mp.Pool(cfg.num_cpus) as pool:
    positions = pool.map(stitch_T_fn, [T])[0]
# %%
...
if len(target_Ts) > 1:
    with mp.Pool(cfg.num_cpus) as pool:
        positions = pool.map(stitch_T_fn, target_Ts[1:])
